<template>
    <section>
        <div class="md:p-12 p-6 md:flex justify-between md:space-y-0 space-y-8">
            <div>
                <h5 class="text-xl uppercase font-medium text-gray-800">Welcome</h5>
            ...
            <div>
                <img class="w-full" src="../assets/images/hero.webp" alt="">
            </div>
        </div>
